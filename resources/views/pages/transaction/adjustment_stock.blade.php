        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header">
                    <strong class="card-title">Form Adjustment Oil Transaction</strong>
                </div>
                <div class="card-body">
                    <form method="POST" id="myForm" action="{{ route('transactions.store-adjustment-stock') }}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <label for="inputAddress2">Adjustment Type</label>
                                <select class="form-control @error('adj_type') is-invalid @enderror" name="adj_type">
                                    ...
                                    <option value="PORC" {{ old('adj_type') == 'PORC' ? 'selected' : '' }}>PORC
                                    </option>
                                    <option value="CONS" {{ old('adj_type') == 'CONS' ? 'selected' : '' }}>CONS
                                    </option>
                                </select>
                                @error('adj_type')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                        ...
                        <input type="hidden" name="doc_type" value="ADJI">
